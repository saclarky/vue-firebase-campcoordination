      ...
      <div class="modal-wrapper">
        <div class="modal-container">
          ...
          <div class="modal-body">
            <div>This will delete all the entries for this date.</div>
            <form v-on:submit.prevent>
            <div class="row rowStyle">
              <div class="loader" v-if="showSpinner"></div>
              <button class="rowItem" @click="deleteItinDate">Delete</button>
...
export default {
  ...
  methods: {
    deleteItinDate: function () {
      ...
      this.$store
        .dispatch("deleteItinDayAction", data)
        .then(() => {
