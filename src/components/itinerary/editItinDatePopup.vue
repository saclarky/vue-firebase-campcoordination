          ...
          <div class="modal-body">
            <form v-on:submit.prevent class="column columnStyle">
               ...
               <div class="row rowStyle">
                Move everything on this date to:
              </div>
              <div class="row rowStyle">
              ...
              <div class="row rowStyle">
                ...
                <input type="submit" class="rowItem" @click="editItinDate" value="Save" />
...
export default {
  ...
  methods: {
     editItinDate(e) {
      ...
      this.$store
        .dispatch("editItinDateAction", data)
        .then(() => {
